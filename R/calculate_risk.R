...
#' @param inflow_orgPerLitre concentration of microbiological parameter in inflow
#' to water treatment plant (default: 10 Org/L)
#' @param  treatment_logRemoval reduction of microbiological concentration in water 
#' treatment plant (default: 5.8 log)
...
#' @param  waterConsumption_LitrePerDay daily water consumption (default: 1 L/day)
...
#' or user defined input (default: 9.5 * 10 ^ - 4 infections/year)
#' @param infection_to_illness probability of illness given infection (default: 0.7,
#' i.e. 70 percent illness probability giving infection)
...
#' @param fraction_population fraction of population at risk of getting the illness
#' (default: 1, i.e. 100 percent of population can possibly get the illness, worst-case
#' assumption assuming no prior immunization!)
#' @param target_dalyPerYearPerPerson target disabled adjusted life years (DALY)
#' per person per year (default: 1/1000000 DALY per per person per year, WHO standard)
